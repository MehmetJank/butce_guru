//this page on build wait update
...
//   const CategoryChart({super.key, this.startDate, this.endDate});
...
//   Future<Map<String, double>> calculatePaymentsByCategory(
...
//           future: calculatePaymentsByCategory(
//             formatDateTime(widget.startDate!),
//             formatDateTime(widget.endDate!),
//           ),
